...
namespace PC_Satis_212523305
{
	public partial class Form1 : Form
	{
		...
		{
			InitializeComponent();
			Load += btnmustlist_Click; //PROGRAM AÇILIŞINDA MÜŞTERİ TABLOSUNUN GÖRÜNTÜLENMESİ
		}
		...
		{
			int sonuc;
			connection = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\\PC_Satis_212523305.accdb");
